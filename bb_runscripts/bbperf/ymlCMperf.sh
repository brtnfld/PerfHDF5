...
python ./doyFilesftp.py $HOST $DIRN $PLATFORM $PLATFORM $CONFIG bbparams ctest DTP/extra $CONFFILE
python ../../doftp.py $HOST $DIRN scripts3 . doyCTbuild.py
#
#combust_io
python ./doyFilesftp.py $HOST $DIRN $PLATFORM $PLATFORM $CONFIG combust_io ctest DTP/extra $CONFFILE
python ./doyCTbuild.py $HOST $DIRN $CONFFILE $CONFIG combust_io ctest $PLATFORM $OSSIZE insbin "$DATASTORE"
#
#h5core
python ./doyFilesftp.py $HOST $DIRN $PLATFORM $PLATFORM $CONFIG h5core ctest DTP/extra $CONFFILE
python ./doyCTbuild.py $HOST $DIRN $CONFFILE $CONFIG h5core ctest $PLATFORM $OSSIZE insbin "$DATASTORE"
#
#h5perf
python ./doyFilesftp.py $HOST $DIRN $PLATFORM $PLATFORM $CONFIG h5perf ctest DTP/extra $CONFFILE
python ./doyCTbuild.py $HOST $DIRN $CONFFILE $CONFIG h5perf ctest $PLATFORM $OSSIZE insbin "$DATASTORE"
#
#seism-core
python ./doyFilesftp.py $HOST $DIRN $PLATFORM $PLATFORM $CONFIG seism-core ctest DTP/extra $CONFFILE
python ./doyCTbuild.py $HOST $DIRN $CONFFILE $CONFIG seism-core ctest $PLATFORM $OSSIZE insbin "$DATASTORE"
#
python ./readJSON.py
#
cd ../../..
