...
plot 'cgns_indtime.dat' using 2:xtic(1), for [i=3:31] '' using i lt palette frac i/31.

#plot newhistogram "1.8", \
#'cgns_indtime.dat'  using 2:xtic(1), for [i=3:31] '' using i lt palette frac i/31.,\
#newhistogram "1.10",\
#'' using 2:xtic(1), for [i=3:31] '' using i lt palette frac i/31.,\
#newhistogram "1.12", \
#'' using 2:xtic(1), for [i=3:31] '' using i lt palette frac i/31.,\
#newhistogram date, \
#'' using 2:xtic(1), for [i=3:31] '' using i lt palette frac i/31.
