...
set mrtics default
set nomttics
set xtics border in scale 1,0.5 mirror rotate by -50  autojustify
...
#'prog-timing.1' i 0 using 2:3:4:xtic(1) ti "--enable-using-memchecker" lt 3 linecolor rgb "#888888",\
#newhistogram "1.10",\
#'prog-timing' i 1 using 2:3:4:xtic(1) noti lt 3 linecolor rgb "#9764b2",\
#'prog-timing.1' i 1 using 2:3:4:xtic(1) noti lt 3 linecolor rgb "#888888",\
#newhistogram "1.12", \
#'prog-timing' i 2 using 2:3:4:xtic(1) noti lt 3 linecolor rgb "#ff5f7e",\
#'prog-timing.1' i 2 using 2:3:4:xtic(1) noti lt 3 linecolor rgb "#888888",\
#newhistogram date, \
