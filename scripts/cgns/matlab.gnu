...
set grid layerdefault   lt 1 linewidth 2.00,  lt 0 linewidth 0.500
#set grid ytics lc rgb "#e41a1c"
set raxis
...
unset style line
set style line 1  linecolor rgb "#737373"  linewidth 2.000 dashtype solid pointtype 6 pointsize default pointinterval 0
...
unset style arrow
set style histogram clustered gap 2 title textcolor lt -1 font "Times Bold,18" boxed offset 0,0.1
unset object
...
set mcbtics default
set mrtics default
set xtics border in scale 0,0 mirror rotate by -67  autojustify
...
unset paxis 6 tics
unset paxis 7 tics
set title "writeLargeNumDsets.cpp, 4 runs per HDF5 version, Jelly (CentOS 7)" 
...
set xlabel "\nHDF5 Version" offset 0,-2
set xlabel  font "Times Bold,32" textcolor lt -1 norotate
set x2label "" 
set x2label  font "" textcolor lt -1 norotate
set xrange [ * : * ] noreverse nowriteback
set x2range [ * : * ] noreverse nowriteback
set ylabel "Time (seconds)" 
set ylabel  font "Times Bold,32" textcolor lt -1 rotate by -270  offset -2
set y2label "" 
...
plot newhistogram "1.6" tc rgb "#9764b2" font "Times Bold,,28", \
f1 i 0 u 2:xtic(1) noti linecolor rgb "#9764b2",\
newhistogram "1.8" tc rgb "#337000" font "Times Bold,,28", \
f1 i 1 u 2:xtic(1) noti linecolor rgb "#377eb8",\
newhistogram "1.10" tc rgb "#e41a1c" font "Times Bold,,28",\
f1 i 2 u 2:xtic(1) noti linecolor rgb "#e41a1c",\
newhistogram "1.12" tc rgb "#4daf4a" font "Times Bold,,28", \
f1 i 3 u 2:xtic(1) noti linecolor rgb "#4daf4a",\
newhistogram date tc rgb "#ffa600" font "Times Bold,,28", \
f1 i 4 u 2:xtic(1) noti linecolor rgb "#ffa600"
}

f1 = "matlab-timings.2022.07.28-14.01.13"
f2 = "matlab-timings.2022.07.28-14.02.42"
f3 = "matlab-timings.2022.07.28-14.03.42"
f4 = "matlab-timings.2022.07.28-14.04.37"

if ( 1 ) { 

plot newhistogram "1.6" tc rgb "#9764b2" font "Times Bold,28", \
f1 i 0 u 2:xtic(1) noti linecolor rgb "#9764b2",\
f2 i 0 u 2:xtic(1) noti linecolor rgb "#9764b2",\
f3 i 0 u 2:xtic(1) noti linecolor rgb "#9764b2",\
f4 i 0 u 2:xtic(1) noti linecolor rgb "#9764b2",\
newhistogram "1.8" tc rgb "#377eb8" font "Times Bold,28", \
f1 i 1 u 2:xtic(1) noti linecolor rgb "#377eb8",\
f2 i 1 u 2:xtic(1) noti linecolor rgb "#377eb8",\
f3 i 1 u 2:xtic(1) noti linecolor rgb "#377eb8",\
f4 i 1 u 2:xtic(1) noti linecolor rgb "#377eb8",\
newhistogram "1.10" tc rgb "#e41a1c" font "Times Bold,28",\
f1 i 2 u 2:xtic(1) noti linecolor rgb "#e41a1c",\
f2 i 2 u 2:xtic(1) noti linecolor rgb "#e41a1c",\
f3 i 2 u 2:xtic(1) noti linecolor rgb "#e41a1c",\
f4 i 2 u 2:xtic(1) noti linecolor rgb "#e41a1c",\
newhistogram "1.12" tc rgb "#4daf4a" font "Times Bold,28", \
f1 i 3 u 2:xtic(1) noti linecolor rgb "#4daf4a",\
f2 i 3 u 2:xtic(1) noti linecolor rgb "#4daf4a",\
f3 i 3 u 2:xtic(1) noti linecolor rgb "#4daf4a",\
f4 i 3 u 2:xtic(1) noti linecolor rgb "#4daf4a",\
newhistogram "1.13" tc rgb "#ff6e54" font "Times Bold,28", \
f1 i 4 u 2:xtic(1) noti linecolor rgb "#ff6e54",\
f2 i 4 u 2:xtic(1) noti linecolor rgb "#ff6e54",\
f3 i 4 u 2:xtic(1) noti linecolor rgb "#ff6e54",\
f4 i 4 u 2:xtic(1) noti linecolor rgb "#ff6e54",\
newhistogram date tc rgb "#ffa600" font "Times Bold,28", \
f1 i 5 u 2:xtic(1) noti linecolor rgb "#ffa600",\
f2 i 5 u 2:xtic(1) noti linecolor rgb "#ffa600",\
f3 i 5 u 2:xtic(1) noti linecolor rgb "#ffa600",\
f4 i 5 u 2:xtic(1) noti linecolor rgb "#ffa600"
